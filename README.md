...
- режим `Новичок` с безопасным фильтром шаблонов, подсказками печати, финальной проверкой, защитой от преждевременной печати и ручным регрессионным чек-листом;
...
docs/newbie-mode-regression-checklist.md ручная регрессионная проверка режима «Новичок»
docs/newbie-mode-rollback-plan.md       аварийный откат режима «Новичок»

const filters = [
  { title: 'Рекомендовано', query: 'рекомендовано', hint: 'Безопасные рабочие макеты' },
  { title: 'Новичку', query: 'новичку', hint: 'Первые простые расклейки' },
  { title: 'Менеджер', query: 'менеджер', hint: 'Проверить перед печатью' },
  ...
  { title: 'Покупатели', query: 'покупател', hint: 'Поиск вариантов под заявку' },
  { title: 'Объекты', query: 'объект', hint: 'Продажа квартиры, дома, участка' },
  ...
  { title: 'Пустые под проверку', query: 'пустой', hint: 'С нуля, только с контролем' }
];

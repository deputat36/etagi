...
const report = {
  ...
  ready,
  checks: {
    release: {status: releaseStatus, ...releaseChecks},
    manualPrint: {status: acceptanceStatus, issue: 40, ...acceptanceChecks},
    managerReview: {status: managerReviewStatus, issue: 51, ...managerReviewChecks},

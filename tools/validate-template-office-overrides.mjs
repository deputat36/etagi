...
const expectedPolicies = {
  ...
  buyer_have_object: {recommended:false, level:'manager', risk:'high', recommendedPrintCount:2},
  buyer_need_family: {recommended:true, level:'newbie', risk:'low', recommendedPrintCount:2},
  buyer_mortgage: {recommended:false, level:'manager', risk:'high', recommendedPrintCount:2},
  buyer_specific_search: {recommended:false, level:'manager', risk:'high', recommendedPrintCount:4},
  object_flat_photo: {recommended:true, level:'manager', risk:'medium', recommendedPrintCount:2},
  object_flat_two_photos: {recommended:true, level:'manager', risk:'medium', recommendedPrintCount:2},
  object_big_photo: {recommended:true, level:'manager', risk:'medium', recommendedPrintCount:1},
  object_new_price: {recommended:true, level:'manager', risk:'medium', recommendedPrintCount:4},
